...
CREATE INDEX IF NOT EXISTS idx_kitchen_logs_tenant_id ON kitchen_logs(tenant_id);
CREATE INDEX IF NOT EXISTS idx_kitchen_logs_order_item_id ON kitchen_logs(order_item_id);
