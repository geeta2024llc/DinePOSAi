...
export const defaultCmsConfig: CmsConfig = {
  homepage: {
    ...
    trialTitle: "7 Days Free Trial",
    trialDesc: "Experience the complete power of DinePOS AI with all premium features unlocked during your trial. No credit card required. After 7 days, choose the plan that fits your business.",
  ...
  auth: {
    ...
    signupRightEyebrow: "Free Trial — 7 Days",
